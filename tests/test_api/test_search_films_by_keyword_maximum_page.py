...
def test_search_films_by_keyword_maximum_page(search_results_page):
    results = search_results_page.search_films(keyword="мстители", page=7)
    assert results["pagesCount"] >= 7  # Проверяем, что страниц достаточно
