...
def test_search_films_by_keyword_second_page(search_results_page):
    results = search_results_page.search_films(keyword="мстители", page=2)
    assert results["pagesCount"] >= 2  # Проверяем, что страниц достаточно
